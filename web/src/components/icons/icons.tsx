...
export const OnyxLogoTypeIcon = ({
  ...
  const aspectRatio = 210 / 36; // Calculate from viewBox values
  const height = size / aspectRatio; // Maintain aspect ratio

  return (

      <img
        src="/logotype.svg" // Ensure this path points to your SVG in the public directory
        alt="Inowaiv Logo"
        width={size}
        height={height}
...
export const OnyxIcon = ({
  ...
  return (
     <img
        src="/logo.svg" // Ensure this path points to your SVG in the public directory
        alt="Inowaiv Logo"
        width={size}
        height={size}
